//Button for deleteing the Status
export function ButtonDeleteStatus({ deleteStatus, type }) {
  return <button onClick={() => deleteStatus(type)} className="ml-2 text-red-600">
    <span>
      <svg
